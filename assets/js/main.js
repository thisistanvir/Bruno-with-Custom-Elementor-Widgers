(function ($) {
	...
	if ($sliderActvation.length > 0) {
		$sliderActvation.slick({
			prevArrow:
				'<button class="prev_arrow"><i class="ei ei-arrow_left"></i></button>',
			nextArrow:
				'<button class="next_arrow"><i class="ei ei-arrow_right"></i></button>',
		});
	}
	...
	$(".blog_page_gallery,.portfolio_page_gallery").imagesLoaded(function () {
		...
		$(".blog_messonry_button,.portfolio_messonry_button").on(
			"click",
			"button",
			function () {
