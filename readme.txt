=== Bruno Theme with Custom Elementor ===

Contributors: iTanvir
Tags: custom widgets, custom-background, custom-logo, custom-menu, featured-images, threaded-comments, translation-ready
...
A lightweight, bruno theme for Elementor page builder.
...
4. A notice box may appear, recommending you to install Elementor Page Builder and Others Plugin. You can either use it or any other editor.
...
* `bruno_page_title`                    show\hide page title (default: show)
* `bruno_viewport_content`              modify `content` of `viewport` meta in header